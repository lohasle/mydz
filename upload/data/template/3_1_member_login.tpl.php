...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1420526383, '1', './data/template/3_1_member_login.tpl.php', './template/default', 'member/login')
