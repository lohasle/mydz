...
if(!defined('IN_DISCUZ')) {
    exit('http://localhost/Discuz_X3.2/upload/');
}
...
function splugin_thinks($identifier, $show = '1'){
	...
	if(splugin_cloudaddon('&mod=app&ac=validator&addonid='.$addonid.($array !== false ? '&rid='.$array['RevisionID'].'&sn='.$array['SN'].'&rd='.$array['RevisionDateline'] : '')) === '0') {
			...
			echo "&#x611F;&#x8C22;&#x4F7F;&#x7528;1314&#x5B66;&#x4E60;&#x7F51;&#x7684;&#x63D2;&#x4EF6;&#xFF0C;&#x767E;&#x5EA6;&#x641C;&#x7D22; 1314&#x5E94;&#x7528;&#x4E2D;&#x5FC3; &#x83B7;&#x53D6;&#x66F4;&#x591A;&#x5E94;&#x7528;&#x3002;<div style='display:none'>\n2014122915x3XmHfsvAW\n34159\n1397217601\nhttp://localhost/Discuz_X3.2/upload/\nhttp://localhost/Discuz_X3.2/upload/\n116A1594-CDD8-728C-FC79-7D80FF05D54D\n----</div>";
	}
}
...
function s_addon_stat($plugin,$action){
	...
	$_statInfo['SiteUrl'] = 'http://localhost/Discuz_X3.2/upload/';
	$_statInfo['ClientUrl'] = 'http://localhost/Discuz_X3.2/upload/';
	$_statInfo['SiteID'] = '116A1594-CDD8-728C-FC79-7D80FF05D54D';
